...
app.post("/api/admin/bulk-update-items", async (req, res) => {
  try {
...
app.patch("/api/orders/:orderId/items/:productId", async (req, res) => {
  try {
    ...
    console.error("PATCH /api/orders/:orderId/items/:productId error:", error);
    res
      .status(500)
...
// Get all shopping list items (with product details)
...
app.get("/api/delivery-status/:megaOrderId", async (req, res) => {
...
app.get("/api/payment-status/:megaOrderId", async (req, res) => {
  const { megaOrderId } = req.params;
...
app.post("/api/discount-products", async (req, res) => {
...
app.delete("/api/discount-products/:productId", async (req, res) => {
...
app.delete("/api/discount-products", async (req, res) => {
  try {
    const { error } = await supabase
      .from("discount_products")
      .delete()
